...
def test_index():
    ...
    assert (
        r.recordings[0].index_url
        == "//cdn.c3voc.de/relive/wevsclimatecrisis/index.json"
    )
...
def test_recordings():
    ...
    assert (
        unreleased[0].get_video_url()
        == "https://cdn.c3voc.de/relive/rc3/11575/muxed.mp4"
    )
    assert unreleased[0].thumbnail == "//cdn.c3voc.de/relive/rc3/11575/thumb.jpg"
    assert (
        unreleased[0].get_thumb_url()
        == "https://cdn.c3voc.de/relive/rc3/11575/thumb.jpg"
    )
